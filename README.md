...
consequence, another source concept, a custom question/source/direction, or finish. Pi then makes
...
| `c` | Save and enter a custom question, source excerpt, or direction for the next card |
| `n` / `Esc` | Skip it |
